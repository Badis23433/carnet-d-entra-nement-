...
export default function ProgresPage() {
  ...
  const [tab, setTab] = useState<"poids" | "charges">("poids");
    ...
    <div className="pb-4">
      ...
      <header className="mb-5">
        ...
        <p className="text-dim text-[14.5px] mt-1">
          Poids de corps et évolution des charges
        </p>
      </header>
      ...
      <div className="flex gap-2 mb-5">
        <button
          ...
          className={`chip ${tab === "poids" ? "active" : ""}`}
        >
          Poids de corps
        </button>
        <button
      ...
      {!ready || !userId ? (
        ...
        <PoidsSection userId={userId} />
      ) : (
        <ChargesSection userId={userId} />
      )}
    </div>
  );
}
