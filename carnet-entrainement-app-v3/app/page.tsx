...
import { PROGRAM, ProgramDay, DEFAULT_REST_SECONDS } from "@/lib/data";
...
export default function SeancePage() {
  ...
  async function handleFreeSubmit(e: React.FormEvent) {
    ...
    startRest(DEFAULT_REST_SECONDS, freeExercise);
    setFreeWeight("");
    setFreeSets("");
    setFreeReps("");
  }
  ...
  async function handleDeleteToday(id: string) {
            ...
            {todayEntries.map((e) => (
              ...
              >
                ...
                <span className="text-dim flex items-center gap-2">
                  ...
                  <button
                    onClick={() => handleDeleteToday(e.id)}
                    className="text-dim hover:text-[#c0524a]"
